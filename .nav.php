<nav>
	<table>
		<tr>
			...
			<td class="cuenta"><div id="cuenta"><a class="<?php if ($ac==12) { echo activo2;}?>" href="#">mi cuenta</a></div><div class="triangulo_top_right"></div></td>
			<td id="buscar"><a href="#"><input type="search" required></a></td>
		</tr>
	</table>
</nav>